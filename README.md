...
-   **Боковая панель (Sidebar) слева:**
    ...
    *   **Вкладка "Переменные":** Отображает все переменные, которые вы используете в схеме. Позволяет отслеживать, где переменная была создана и где используется, что очень помогает в отладке.
...
-   Когда вы довольны результатом, нажмите **"Сохранить схему"**, чтобы сохранить вашу схему.
