...
const VideoSettings: React.FC<{ nodeId: string }> = ({ nodeId }) => {
    ...
    return (
        <div className="space-y-6">
            <SettingRow label="Источник видео" helpText="Введите публичный URL или загрузите видеофайл.">
                <input
                    type="text"
                ...
                {url && (
                    <div className="mt-4 p-2 bg-background rounded-lg">
                        ...
                        <video src={url} controls className="rounded-md max-w-full max-h-40 mx-auto" />
                    </div>
                )}
            </SettingRow>
